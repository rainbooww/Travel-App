...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post destinations_url, params: { destination: { address: @destination.address, city: @destination.city, country: @destination.country, description: @destination.description, latitude: @destination.latitude, longitude: @destination.longitude } }
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { address: @destination.address, city: @destination.city, country: @destination.country, description: @destination.description, latitude: @destination.latitude, longitude: @destination.longitude } }
